...
public final class Util {
  ...
  public static boolean contains(Object[] items, Object item) {
    for (Object arrayItem : items) {
      if (com.google.android.exoplayer2.util.Util.areEqual(arrayItem, item)) {
        return true;
      }
    }
    return false;
  ...
  public static Point getPhysicalDisplaySize(Context context, Display display) {
    if (com.google.android.exoplayer2.util.Util.SDK_INT < 25 && display.getDisplayId() == Display.DEFAULT_DISPLAY) {
      ...
      if ("Sony".equals(com.google.android.exoplayer2.util.Util.MANUFACTURER) && com.google.android.exoplayer2.util.Util.MODEL.startsWith("BRAVIA")
          && context.getPackageManager().hasSystemFeature("com.sony.dtv.hardware.panel.qfhd")) {
        return new Point(3840, 2160);
      } else if ("NVIDIA".equals(com.google.android.exoplayer2.util.Util.MANUFACTURER) && com.google.android.exoplayer2.util.Util.MODEL.contains("SHIELD")) {
    ...
    } else if (com.google.android.exoplayer2.util.Util.SDK_INT >= 17) {
      getDisplaySizeV17(display, displaySize);
    } else if (com.google.android.exoplayer2.util.Util.SDK_INT >= 16) {
