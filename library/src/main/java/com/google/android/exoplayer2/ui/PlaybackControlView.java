...
import static com.google.android.exoplayer2.R.id.fullscreen;
...
//  private final View rewindButton;
  ...
  public PlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    fullScreen = (ImageView) findViewById(fullscreen);
    ...
    btn_play.setOnClickListener(componentListener);
...
//    fastForwardButton.setOnClickListener(componentListener);
  ...
  private void updatePlayPauseButton() {
    ...
    btn_play.setContentDescription(contentDescription);
    btn_play.setImageResource(
        playing ? R.drawable.jc_click_pause_selector : R.drawable.jc_click_play_selector);
  }
...
//    setButtonEnabled(rewindMs > 0 && isSeekable, rewindButton);
    ...
    public void onClick(View view) {
      ...
      /*if (nextButton == view) {
        ...
        if (fullScreenListener != null){
          fullScreenListener.fullScreenClick();
        }
      }else if (btn_play == view){
        player.setPlayWhenReady(!player.getPlayWhenReady());
      }
      hideAfterTimeout();
    }
  ...
  public void setFullScreenVisible(boolean isVisible){
    fullScreen.setVisibility(isVisible ? View.VISIBLE : View.GONE);
  }
}
